...
class VQGANTransformer(nn.Module):
    def __init__(self, args):
        ...
        transformer_config = {
            ...
            "block_size": args.block_size, # 512
            "n_embed": args.n_embed, # 1024
            "n_head": args.n_head, # 16
            "n_layer": args.n_layer, # 24
        }
        self.transformer = GPT(**transformer_config)
        self.pkeep = args.pkeep

        self.embed_dim = args.embed_dim # 256
    ...
    def z_to_image(self, indices, p1=16, p2=16):
        ix_to_vectors = self.vqgan.codebook.embedding(indices).reshape(indices.shape[0], p1, p2, self.embed_dim)
